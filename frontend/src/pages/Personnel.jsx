...
import { Shield, Plus, Calendar, DollarSign, Edit3 } from 'lucide-react';
  ...
  return (
    <MainLayout>
      ...
      <DetailDrawer
        ...
        subtitle={`Badge: ${selectedGuard?.badge_number} | Daily Rate: ${formatCurrency(selectedGuard?.daily_rate)}`}
        data={{
          ...selectedGuard,
